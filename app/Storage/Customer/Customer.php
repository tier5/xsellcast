...
class Customer extends Model implements Transformable {
    ...
    public function brands() {
        return $this->belongsToMany('App\Storage\Brand\Brand', 'customer_brands', 'customer_id', 'brand_id');
    }
    ...
    public function pivotBrands() {
        return $this->hasMany('App\Storage\CustomerBrand\CustomerBrand', 'customer_id', 'id');
    }
