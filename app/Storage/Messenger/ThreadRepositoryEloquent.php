...
class ThreadRepositoryEloquent extends BaseRepository implements ThreadRepository
{
    ...
    */
    ...
    public function createMessage($sender = null, $recepient, $body, $type, $subject = null, $offer_id = null)
    {
        ...
        if($type != 'message' && $type != 'system')
        {
            ...
            if(!$offer_id && !in_array($type, ['lead_reassign', 'new_lead']))
            { 
                abort(402, 'Offer field is required.');
            } 
        }else{
     ...
     * @return     boolean
     */
    public function assignCustToSalesRep($cust_user_id, $salesrep_user_id, $offer_id, $type, $approved = false)
    {
