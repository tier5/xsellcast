...
/**
 * This request is for App\Http\Controllers\Admin\SalesRep\SalesRepController
 */
class SalesRepUpdateRequest extends Request
{
    /**
    ...
    {
        $salesRep = SalesRep::find($this->route('salesrep_id'));
        $user = $salesRep->user;
        
        $this->attributes->add(['user' => $user, 'salesrep' => $salesRep]);
