...
return [
    ...
    'message_types'            => [
        ...
        'system'        => [
            ...
            'badge'              => 'default'],
        'brand_catalog' => [
            'simple'             => 'Brand Catalog',
            'name'               => 'Brand Catalog Request',
            'head_name'          => 'Brand Catalog Requests',
            'head_name_singular' => 'Brand Catalog Request',
            'badge'              => 'primary'],
        'map_location'  => [
            'simple'             => 'Map Location',
            'name'               => 'Map Location Request',
            'head_name'          => 'Map Location Requests',
            'head_name_singular' => 'Map Location Request',
            'badge'              => 'info'],
    ],
