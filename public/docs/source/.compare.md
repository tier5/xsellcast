...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brands" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brands",
    "method": "GET",
    "data": {
        "access_token": "aut",
        "page": 99751627
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand/{id}" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand/{id}",
    "method": "GET",
    "data": {
        "access_token": "error"
},
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customers" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customers",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/{id}" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/{id}",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/{id}/brand-associates" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/{id}/brand-associates",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/{id}/offers" \
-H "Accept: application/json" \
    -d "access_token"="quae" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/{id}/offers",
    "method": "GET",
    "data": {
        "access_token": "quae"
},
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/offer" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/customer/offer",
    "method": "POST",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealers" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealers",
    "method": "GET",
    "data": {
        "access_token": "dolor",
        "page": 60,
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealer/{id}" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealer/{id}",
    "method": "GET",
    "data": {
        "access_token": "optio"
},
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealer/{id}/brands" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealer/{id}/brands",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealer/{id}/brand-associates" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/dealer/{id}/brand-associates",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/direct-message" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/direct-message",
    "method": "GET",
    "data": {
...
<!-- START_f09d00cbafdc43e766a13c482f119937 -->
## Single
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/direct-message/{id}" \
-H "Accept: application/json" \
    -d "access_token"="assumenda" \
    -d "customer_id"="assumenda" \
    -d "message_id"="assumenda" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/direct-message/{id}",
    "method": "GET",
    "data": {
...
### HTTP Request
`GET api/v1/messages/direct-message/{id}`

`HEAD api/v1/messages/direct-message/{id}`
...
<!-- END_f09d00cbafdc43e766a13c482f119937 -->
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/direct-message/store" \
-H "Accept: application/json" \
    -d "access_token"="voluptatum" \
    -d "customer_id"="voluptatum" \
    -d "salesrep_id"="voluptatum" \
    -d "message_id"="voluptatum" \
    -d "body"="voluptatum" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/direct-message/store",
    "method": "POST",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/offers" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/offers",
    "method": "GET",
    "data": {
        "access_token": "rerum",
        "page": 796437556
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/offer/{id}" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/offer/{id}",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/appt" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/appt",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/appt/{id}" \
-H "Accept: application/json" \
    -d "access_token"="quo" \
    -d "customer_id"="quo" \
    -d "message_id"="quo" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/appt/{id}",
    "method": "GET",
    "data": {
        "access_token": "quo",
        "customer_id": "quo",
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/appt/store" \
-H "Accept: application/json" \
    -d "access_token"="ut" \
    -d "customer_id"="ut" \
    -d "salesrep_id"="ut" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/appt/store",
    "method": "POST",
    "data": {
        "access_token": "ut",
        "customer_id": "ut",
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/info" \
-H "Accept: application/json" \
    -d "access_token"="aut" \
    -d "customer_id"="aut" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/info",
    "method": "GET",
    "data": {
        "access_token": "aut",
        "customer_id": "aut"
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/info/{id}" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/info/{id}",
    "method": "GET",
    "data": {
        "access_token": "quidem",
        "customer_id": "quidem",
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/info/store" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/info/store",
    "method": "POST",
    "data": {
        "access_token": "autem",
        "customer_id": "autem",
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/price" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/price",
    "method": "GET",
    "data": {
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/price/{id}" \
-H "Accept: application/json" \
    -d "access_token"="vero" \
    -d "customer_id"="vero" \
    -d "message_id"="vero" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/price/{id}",
    "method": "GET",
    "data": {
        "access_token": "vero",
        "customer_id": "vero",
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/price/store" \
-H "Accept: application/json" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/messages/request/price/store",
    "method": "POST",
    "data": {
        "access_token": "omnis",
        "customer_id": "omnis",
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand-associates" \
-H "Accept: application/json" \
    -d "access_token"="et" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand-associates",
    "method": "GET",
    "data": {
        "access_token": "et"
},
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand-associate/{id}" \
-H "Accept: application/json" \
    -d "access_token"="autem" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand-associate/{id}",
    "method": "GET",
    "data": {
        "access_token": "autem"
},
...
Get a list of customers related to sales rep.

> Example request:

```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand-associate/{id}/customers" \
-H "Accept: application/json" \
    -d "access_token"="non" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/brand-associate/{id}/customers",
    "method": "GET",
    "data": {
        "access_token": "non"
},
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/users" \
-H "Accept: application/json" \
    -d "access_token"="est" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/users",
    "method": "GET",
    "data": {
        "access_token": "est"
},
...
```bash
curl "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/users/store" \
-H "Accept: application/json" \
    -d "firstname"="nam" \
    -d "lastname"="nam" \
    -d "access_token"="nam" \
...
var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://xsellcast.dev.127.0.0.1.xip.io/api/v1/users/store",
    "method": "POST",
    "data": {
        "firstname": "nam",
        "lastname": "nam",
